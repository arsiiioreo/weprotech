    ...
    <body class="antialiased d-flex flex-column justify-content-center w-100" style="background-color: #191919; position: relative;">
        ...
        @if ($agent->isMobile())
            <div class="first-section w-100 p-4 d-flex flex-column" style="position: relative; min-height: 100vh; height: auto; background: linear-gradient(to bottom, #191919 10%, #1919197e, #272727);">
                ...
                <!-- Header -->
                <div class="header d-flex flex-column flex-md-row justify-content-between align-items-center px-3 px-md-5 mb-5 w-100">
                    <div class="d-flex align-items-center mb-3 mb-md-0">
                        <img src="{{ asset('images/light_logo.png') }}" alt="Logo" class="img-fluid logo me-3" style="height: auto; width: 60px;">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center gap-3">
                        ...
                        @if ($loggedIn)
                        <a href="{{route('home')}}" class="bg-secondary py-2 px-3 rounded text-white">Home</a>
                        @else
                        <a href="#" class="text-white" data-bs-toggle="modal" data-bs-target="#loginModal">Login</a>
                        <a href="#" class="text-white" data-bs-toggle="modal" data-bs-target="#registrationModal">Register</a>
                        @endif
                    </div>
                </div>

                <!-- Main Section -->
                <div class="d-flex flex-column flex-md-row justify-content-center align-items-center h-100 px-3 px-md-5 w-100 mt-4">
                    <div class="d-flex justify-content-center align-items-center mb-5" style="width: 100%; max-width: 400px;">
                        <img src="{{ asset('images/landing_banner.png')}}" alt="" class="img-fluid" style="max-width: 50%; height: auto;">
                    </div>
                    <div class="d-flex flex-column justify-content-center mb-5 mb-md-0" style="width: 100%; max-width: 600px;">
                        <h1 class="text-white fw-bold mb-3 text-center text-md-start" style="font-size: clamp(2.5rem, 6vw, 7rem);">WEPROTECH</h1>
                        <p class="mb-4 text-white fw-light text-center text-md-start">
                        ...
                        @if ($loggedIn)
                        <a href="{{ route('home') }}" class="btn fw-semibold text-center mx-auto mx-md-0 rounded px-4 py-2" style="background-color: white; color: #191919; font-size: 0.7rem;">Get Started</a>
                        @else
                        <button class="btn fw-semibold mx-auto mx-md-0 rounded px-4 py-2" style="background-color: white; color: #191919;" data-bs-toggle="modal" data-bs-target="#registrationModal">Get Started</button>
                        @endif
                    </div>
                </div>
                ...
                @endphp
                <div class="d-flex flex-wrap justify-content-center align-items-center mt-5 gap-5 px-4">
                    @foreach ($countCards as $item)
                    <div class="count-card d-flex flex-column align-items-center text-center m-4" style="min-width: 120px;">
                        <i class="bi bi-{{$item['icon']}} text-white mb-2" style="font-size: 1.5rem;"></i>
                        <h2 class="text-white fw-bold mb-0">{{ ${$item['var']} }}+</h2>
                        <p class="text-white mb-0" style="font-weight: 300;">{{$item['text']}}</p>
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="bg-white p-5 w-100">
                ...
                <div class="container py-5">
                    <div class="row justify-content-center g-4">
                        @php
                            $serviceCards = [
                                'storage' => ['icon' => 'bi-lock', 'title' => 'Secure Vault Storage', 'text' => 'We provide encryption for your sensitive data—passwords, PINs, notes, keys—you name it. Your secrets stay yours.'],
                                'manage' => ['icon' => 'bi-key', 'title' => 'Password Management', 'text' => 'Save and organize your passwords across platforms. Say goodbye to "forgot password?" days.'],
                                'docu' => ['icon' => 'bi-paperclip', 'title' => 'Encrypted Notes & Documents', 'text' => 'Need to jot down recovery phrases, confidential data, or secret plans to take over the world? Store them safely inside encrypted containers.'],
                            ];
                        @endphp

                        @foreach ($serviceCards as $item)
                        <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center">
                            <div class="service-card text-center p-4 h-auto w-75" style="max-width: 320px; border: 3px solid #191919; border-radius: 10px;">
                                <i class="bi {{$item['icon']}}" style="font-size: 2rem; font-weight: 900;"></i>
                                <h5 class="fw-bold mb-3 mt-4">{{$item['title']}}</h5>
                                <p class="mb-0 px-2" style="font-weight: 400;">{{$item['text']}}</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="d-flex flex-column justify-content-center align-items-center mb-5">
                ...
                <div class="d-flex align-items-center gap-2">
                    <button data-bs-toggle="modal" data-bs-target="#loginModal" class="btn btn-light border-light bg-none fw-bold px-5">LOGIN</button>
                    <button data-bs-toggle="modal" data-bs-target="#registrationModal" class="btn btn-light fw-bold px-5">REGISTER</button>
                </div>
                @endif
            </div>
            <div class="d-flex align-items-center flex-column justify-content-between" style="background-color: #dadada; width: 100%;">
                <div class="d-flex flex-column justify-content-center align-items-center h-100 mb-5">
                    <img class="img-fluid w-75 pt-4" src="{{asset('images/dark_logo.png')}}" alt="">
                    <p class="fs-1" style="font-weight: 900">WEPROTECH</p>
                </div>
                <div class="d-flex flex-column justify-content-start align-items-center h-100 w-100" style="font-size: 0.85rem;">
                    ...
                    <div class="text-center">
                        <div class="d-flex flex-column mb-5 text-start">
                            <h5 class="fw-bold mb-3 text-center">Contact Us</h5>
                            <p class="">
                        ...
                        <div class="d-flex flex-column mb-5">
                            ...
                            <ul class="text-start">
                                ...
                                <li class="mb-1 position-relative">
                                    Diary
                                    <span class="position-absolute top-0 badge text-danger fw-semibold" style="font-size: 0.35rem;">
                                        <i>beta</i>
                                    </span>
                                </li>
                            </ul>
